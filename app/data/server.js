...
app.get("/bookings", function (req, res) {
    const query = `
        ...
        FROM bookings
        LEFT JOIN pets ON bookings.pet_id = pets.pet_id
        LEFT JOIN users ON pets.user_id = users.user_id
        LEFT JOIN rooms ON bookings.room_id = rooms.room_id
        LEFT JOIN room_type ON rooms.type_type_id = room_type.type_id
        LEFT JOIN pet_type ON room_type.pet_type = pet_type.pet_type_id
        LEFT JOIN payment_methods ON bookings.payment_method = payment_methods.method_id
        WHERE pets.deleted_at IS NULL
